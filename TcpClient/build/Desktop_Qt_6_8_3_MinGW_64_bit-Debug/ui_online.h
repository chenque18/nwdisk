...
public:
    ...
    void setupUi(QWidget *Online)
    {
        ...
        addfriend_btn = new QPushButton(Online);
        addfriend_btn->setObjectName("addfriend_btn");
        addfriend_btn->setFont(font);

        verticalLayout->addWidget(addfriend_btn);
    ...
    void retranslateUi(QWidget *Online)
    {
        ...
        addfriend_btn->setText(QCoreApplication::translate("Online", "\345\212\240\345\245\275\345\217\213", nullptr));
    } // retranslateUi
