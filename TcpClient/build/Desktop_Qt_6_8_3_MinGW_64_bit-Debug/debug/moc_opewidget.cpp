...
static constexpr auto qt_meta_stringdata_ZN9OpeWidgetE = QtMocHelpers::stringData(
    "OpeWidget"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN9OpeWidgetE[] = {
...
Q_CONSTINIT const QMetaObject OpeWidget::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN9OpeWidgetE.offsetsAndSizes,
    qt_meta_data_ZN9OpeWidgetE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN9OpeWidgetE_t,
        // Q_OBJECT / Q_GADGET
...
void *OpeWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN9OpeWidgetE.stringdata0))
